    ...
    <div class="container-fluid">
        <div class="card overflow-hidden">
            <div class="card-body p-0">
                <img src="<?= base_url() ?>assets\img\home\wallpaper.jpg" alt="" class="img-fluid">
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-2">
                                <div class="linear-gradient d-flex align-items-center justify-content-center rounded-circle"
                                    ...
                                    <div class="border border-4 border-white d-flex align-items-center justify-content-center rounded-circle overflow-hidden"
                                        ...
                                        <img src="<?= base_url() ?>assets/img/home/profile.jpg" alt=""
                                            class="w-100 h-100">
                                    </div>
                                </div>
                            </div>
                            <div class="text-center">
                                <h5 class="fs-5 mb-0 fw-semibold">Vet Huellitas</h5>
                                <p class="mb-0 fs-4">Empresa</p>
                            </div>
                        </div>
                    </div>
                ...
                <ul class="nav nav-pills user-profile-tab justify-content-end mt-2 bg-light-info rounded-2"
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            <span class="d-none d-md-block">Seguidores</span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button
            ...
            <div class="tab-pane fade" id="pills-friends" role="tabpanel" aria-labelledby="pills-friends-tab"
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="card hover-img">
                            <div class="card-body p-4 text-center border-bottom">
                                <img src="<?= base_url() ?>assets/img/home/user-5.jpg" alt="" class="rounded-circle mb-3"
                                    width="80" height="80">
                                <h5 class="fw-semibold mb-0">Betty Adams</h5>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card hover-img">
                            <div class="card-body p-4 text-center border-bottom">
                                <img src="<?= base_url() ?>assets/img/home/profile.jpg" alt="" class="rounded-circle mb-3"
                                    width="80" height="80">
