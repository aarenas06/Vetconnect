                ...
                <div class="row">
                    <div class="col-xl-7 col-xxl-8">
                        ...
                        <div class="d-none d-xl-flex align-items-center justify-content-center"
                            ...
                            <img src="<?= base_url() ?>assets/img/banner2.png"
                                alt="" class="img-fluid" width="700">
                        </div>
                    </div>
                                ...
                                <form>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <a class="text-primary fw-medium"
                                            href="./authentication-forgot-password.html">¿Olvidaste la contraseña ?</a>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <a class="text-primary fw-medium ms-2"
                                            href="<?=base_url()?>index.php/Portal/Registro">Crear una cuenta</a>
                                    </div>
                                </form>
                            </div>
                        </div>
