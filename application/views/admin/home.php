    ...
    <div class="owl-carousel counter-carousel owl-theme">
            ...
            <div class="card border-0 zoom-in bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <center>
                            <img src="<?= base_url() ?>assets/img/home/icons/doc.png" width="70" height="50"
                                class="mb-3" alt="" />
                        </center>
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-warning shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <center>
                            <img src="<?= base_url() ?>assets/img/home/icons/user.png" width="70" height="50"
                                class="mb-3" alt="" />
                        </center>
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-info shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <center>
                            <img src="<?= base_url() ?>assets/img/home/icons/vets.png" width="70" height="50"
                                class="mb-3" alt="" />
                        </center>
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-danger shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <center>
                            <img src="<?= base_url() ?>assets/img/home/icons/dog.png" width="70" height="50"
                                class="mb-3" alt="" />
                        </center>
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-success shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <center>
                            <img src="<?= base_url() ?>assets/img/home/icons/ganancias.png" width="70" height="50"
                                class="mb-3" alt="" />
                        </center>
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-info shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <center> <img src="<?= base_url() ?>assets/img/home/icons/ticket.png" width="70" height="50"
                                class="mb-3" alt="" />
                        </center>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-7 pb-2">
                        <div class="me-3 pe-1">
                            <img src="<?= base_url() ?>assets\img\home\user-5.jpg" class="shadow-warning rounded-2"
                            ...
                            <tbody class="border-top">
                                <tr>
                                    <td class="ps-0">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 pe-1">
                                                <img src="<?= base_url() ?>assets\img\home\user-5.jpg"
